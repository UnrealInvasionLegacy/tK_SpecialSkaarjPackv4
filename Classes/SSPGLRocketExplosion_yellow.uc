...
//
//-----------------------------------------------------------
class SSPGLRocketExplosion_yellow extends SSPGLRocketExplosion;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(0)=(Color=(B=32,G=255,R=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=32,G=255,R=255))
         MaxParticles=3
     ...
     End Object
     Emitters(0)=SpriteEmitter'tk_SpecialSkaarjPackv4.SSPGLRocketExplosion_yellow.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         Texture=Texture'tk_SpecialSkaarjPackv4.Decal.GayLordTrail_yellow'
         TextureUSubdivisions=4
         TextureVSubdivisions=4
     ...
     End Object
     Emitters(1)=SpriteEmitter'tk_SpecialSkaarjPackv4.SSPGLRocketExplosion_yellow.SpriteEmitter0'
     ...
     End Object
     Emitters(2)=SpriteEmitter'tk_SpecialSkaarjPackv4.SSPGLRocketExplosion_yellow.SpriteEmitter2'
